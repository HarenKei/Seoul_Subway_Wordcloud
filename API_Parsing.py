...
data = []
r = requests.get("http://openapi.seoul.go.kr:8088/(인증키)/xml/CardSubwayStatsNew/1/604/20190101"
                 )
html = r.text
...
wc = WordCloud(font_path='/Users/harenkei/PycharmProjects/SeoulAPI_parsing/BMHANNA_11yrs_.ttf',
               background_color='black', width=1920, height=1080).generate_from_text(station)
